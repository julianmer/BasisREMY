...
if __name__ == "__main__":
    ...
    # configuration
    config = {
        'backend': 'sLaserSim',   # the backend to use for the simulation
        ...
        'run_config': {
            ...
            'userParams': {
                ...
                'Tau 2': 13.,
                'Center Freq': 123.245,
                'Path to Pulse': './externals/jbss/my_pulse/standardized_goia.txt'
            },    # user parameters to override or add to the REMY parameters
    ...
    for test in sorted(os.listdir(remy_test_dir)):
        if test.startswith(('Dataset_04', 'Dataset_05', 'Dataset_06', 'Dataset_07', 'Dataset_08',
                            'Dataset_09', 'Dataset_14', 'Dataset_15', 'Dataset_16', 'Dataset_17',
                            'Dataset_18', 'Dataset_19', 'Dataset_27')):  # Filter on sLASER tests
    ...
    check = ['System', 'Sequence', 'B1max', 'Flip Angle', 'RefTp',
             'Samples', 'Bandwidth', 'Bfield', 'TE', 'Center Freq',
