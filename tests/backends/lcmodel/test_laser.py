"""
LCModel Backend - LASER Sequence Tests
Tests that LCModel backend can simulate LASER sequences  
...
class TestLCModelLASER:
    """Test LCModel backend with LASER sequence"""
    ...
    def test_laser_simulation(self, basisremy, test_output_dir, cleanup_docker_processes):
        """
        Test that LCModel backend can simulate a LASER basis set
