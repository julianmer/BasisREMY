...
%
% NOTE: This file is a BasisREMY adapter that overrides the original
%       FID-A sim_lcmrawbasis.m (externals/fidA/simulationTools/).
%       Two changes from the original:
%         1. Added 'path' argument so output files go to the correct directory.
%         2. Changed spinSystems.mat load path to 'metabolites/spinSystems.mat'.
%       adapters/backends/ is added to the Octave path BEFORE
%       externals/fidA/simulationTools/ so this version takes precedence.
%       The FID-A submodule now points to the unmodified upstream repo:
